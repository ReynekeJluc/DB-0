...
def upgrade() -> None:
    ...
    op.bulk_insert(
            providers,
            [
                {'id': 1, 'name': "Tinkoff", 'address': "Malaya 9", 'phone': "9021693470", 'email': "tink@mail.ru"},
                {'id': 2, 'name': "Alfa", 'address': "Malaya 9", 'phone': "9021693470", 'email': "alfa@mail.ru"},
                {'id': 3, 'name': "Tochka", 'address': "Malaya 9", 'phone': "9021693470", 'email': "tochka@mail.ru"},
                {'id': 4, 'name': "Sberbank", 'address': "Malaya 9", 'phone': "9021693470", 'email': "sber@mail.ru"},
            ]
        )
    ...
    op.bulk_insert(
        ...
        [
            ...
            {'id': 2, 'provider_id': 2, 'date': "2024-10-01 10:01:00"},
            {'id': 3, 'provider_id': 3, 'date': "2024-10-01 10:02:00"},
            {'id': 4, 'provider_id': 4, 'date': "2024-10-01 10:03:00"},
            {'id': 5, 'provider_id': 3, 'date': "2024-10-01 10:04:00"},
...
def downgrade() -> None:
    ...
    op.execute("DELETE FROM orders_sneakers")
    op.execute("DELETE FROM orders")
    op.execute("DELETE FROM sneakers")
