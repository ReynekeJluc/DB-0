...
<<<<<<< HEAD
    ...
    #     RETURNS TRIGGER AS $$                                  -- возвращение триггерного значения $$ - начало и конец текста функции
    #     BEGIN
    ...
    #         ) THEN
    #             RAISE EXCEPTION 'Brand name "%s" already exists', NEW.name;     -- вызываем эксепшен
    #         END IF;
